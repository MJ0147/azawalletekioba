...
$SECRETS = @("TON_API_KEY", "TON_MERCHANT_WALLET", "FLW_SECRET_KEY", "DJANGO_SECRET_KEY", "DATABASE_URL")
$MISSING_SECRETS = @()
...
$SERVICE_URL = Invoke-GCloudCommand -Args @(
    ...
    "--set-secrets", "DJANGO_SECRET_KEY=DJANGO_SECRET_KEY:latest,TON_MERCHANT_WALLET=TON_MERCHANT_WALLET:latest,TON_API_KEY=TON_API_KEY:latest,FLW_SECRET_KEY=FLW_SECRET_KEY:latest,DATABASE_URL=DATABASE_URL:latest",
